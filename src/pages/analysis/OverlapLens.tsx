              ...
              <div className={`rounded-2xl overflow-hidden ${card}`}>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full">
                    <thead>
                      <tr style={{ borderBottom: `1px solid ${divider}` }}>
                        <th className={`text-left px-4 py-2.5 text-[11px] font-semibold ${text} uppercase tracking-widew-48`}>Stock</th>
                        {selectedFunds.map(f => (
              ...
              <div className={`rounded-2xl overflow-hidden ${card}`}>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full">
                    <thead>
                      <tr style={{ borderBottom: `1px solid ${divider}` }}>
                        <th className={`text-left px-4 py-2.5 text-[11px] font-semibold ${text} uppercase tracking-widew-28`}>Sector</th>
                        {selectedFunds.map(f => (
