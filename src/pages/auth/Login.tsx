...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#F4F4F5' }}>
      <div
        className="flex w-full max-w-5xl min-h-[600px] rounded-3xl overflow-hidden mx-4"
      ...
      >
        ...
        <div
          ...
          style={{ backgroundImage: `url(${checkerBg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
          <div>
          ...
          <div className="flex-1 flex items-center justify-center py-8">
            <div
              ...
              style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.10)', backdropFilter: 'blur(4px)' }}
            >
              ...
              <h1 className="text-3xl font-bold leading-tight mb-4" style={{ color: '#FFFFFF' }}>
                Kaunsa{' '}
                <span style={{ color: '#4f46e5', textDecoration: 'underline', textUnderlineOffset: 4 }}>mutual fund</span>
                {' '}sahi hai
